 ...
 */
public class INSIDERECEPTIONISTLOGIN extends javax.swing.JFrame {

    /**
     * Creates new form RECEPTIONIST
     */
    public INSIDERECEPTIONISTLOGIN() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(110, 350, 220, 50);
        ...
        jButton3.setBounds(110, 190, 220, 50);
        ...
        jButton4.setBounds(600, 30, 110, 29);
        ...
        jButton5.setBounds(110, 270, 220, 50);

        jButton6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButton6.setForeground(new java.awt.Color(102, 153, 255));
        jButton6.setText("CREATE APPOINTMENTS");
        ...
        jButton6.setBounds(110, 113, 220, 50);
        ...
        jButton7.setBounds(650, 70, 60, 60);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Muhammad Al Adraa\\Documents\\NetBeansProjects\\cmps277\\pics\\recback.jpg")); // NOI18N
        jPanel1.add(jLabel2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        VIEWINDDINRE dd = new VIEWINDDINRE();
        dd.setVisible(true);
        this.dispose();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        ADDPATIENTT ad = new ADDPATIENTT();
        ad.setVisible(true);
        this.dispose();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        SETAPPOINTMENT s = new SETAPPOINTMENT();
        s.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(INSIDERECEPTIONISTLOGIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new INSIDERECEPTIONISTLOGIN().setVisible(true);
            }
        });
    }
