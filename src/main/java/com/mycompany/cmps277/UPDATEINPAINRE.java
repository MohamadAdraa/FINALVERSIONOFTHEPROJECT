 ...
 */
public class UPDATEINPAINRE extends javax.swing.JFrame {

    /**
     * Creates new form DOCTORDETAILS
     */
//    private String ss = "user.dir";
    public UPDATEINPAINRE() {
        initComponents();
    }
    String s;
    /**
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        VIEWINPAINRE vv = new VIEWINPAINRE();
        vv.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UPDATEINPAINRE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UPDATEINPAINRE().setVisible(true);
            }
        });
    }
